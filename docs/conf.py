# -*- coding: utf-8 -*-
#
# InstantMISO documentation build configuration file
...
if not os.getenv("SPHINX_NO_DESCRIPTIONS"):
    extensions.append("instantmiso_descriptions")
...
author = "Juan Linietsky, Ariel Manzur and the InstantMISO community"
...
supported_languages = {
    "en": "InstantMISO (%s) documentation in English",
    "de": "InstantMISO (%s) Dokumentation auf Deutsch",
    "es": "Documentación de InstantMISO (%s) en español",
    "fr": "Documentation de InstantMISO (%s) en français",
    "fi": "InstantMISO (%s) dokumentaatio suomeksi",
    "it": "InstantMISO (%s) documentazione in italiano",
    "ja": "InstantMISO (%s)の日本語のドキュメント",
    "ko": "InstantMISO (%s) 문서 (한국어)",
    "pl": "Dokumentacja InstantMISO (%s) w języku polskim",
    "pt_BR": "Documentação da InstantMISO (%s) em Português Brasileiro",
    "ru": "Документация InstantMISO (%s) на русском языке",
    "uk": "Документація до InstantMISO (%s) українською мовою",
    "zh_CN": "InstantMISO (%s) 简体中文文档",
    "zh_TW": "InstantMISO (%s) 正體中文 (台灣) 文件",
}
...
html_context = {
    ...
    "github_user": "chefgonpachi",  # Username
    "github_repo": "instantmiso-docs",  # Repo name
    "github_version": "master",  # Version
    "conf_py_path": "/",  # Path in the checkout to the docs root
    "instantmiso_inject_language_links": True,
    "instantmiso_docs_supported_languages": list(supported_languages.keys()),
    "instantmiso_docs_basepath": "https://docs.instantmiso.com/",
    "instantmiso_docs_suffix": ".html",
    "instantmiso_default_lang": "en",
    "instantmiso_canonical_version": "stable",
    # Distinguish local development website from production website.
    # This prevents people from looking for changes on the production website after making local changes :)
    "instantmiso_title_prefix": "" if on_rtd else "(DEV) ",
}
...
htmlhelp_basename = "InstantMISOEnginedoc"
...
latex_documents = [
    (
        master_doc,
        "InstantMISO.tex",
        "InstantMISO Documentation",
        "Chef Gonpachi and the InstantMISO community",
        "manual",
    ),
]
...
# InstantMISO localization is handled via https://github.com/chefgonpachi/MISO/I18n
...
# We want to host the localized images in instantmiso-docs-l10n, but Sphinx does not provide
...
# and point to the parallel folder structure in instantmiso-docs-l10n.
...
def instantmiso_get_image_filename_for_language(filename, env):
    """
    Hack the absolute path returned by Sphinx based on `figure_language_filename`
    to insert our `../images` relative path to instantmiso-docs-l10n's images folder,
...
sphinx.util.i18n.get_image_filename_for_language = instantmiso_get_image_filename_for_language
...
rst_epilog = """
.. |weblate_widget| image:: https://hosted.weblate.org/widgets/instantmiso-engine/{image_locale}/instantmiso-docs/287x66-white.png
    :alt: Translation status
    :target: https://hosted.weblate.org/engage/instantmiso-engine{target_locale}/?utm_source=widget
    :width: 287
    :height: 66
""".format(
